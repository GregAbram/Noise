...
namespace noise
{
  ...
  double GradientCoherentNoise4D (double x, double y, double z, double t, int seed = 0,
    NoiseQuality noiseQuality = QUALITY_STD);
  ...
  double GradientNoise3D (double fx, double fy, double fz, int ix, int iy,
    int iz, int seed = 0);
  double GradientNoise4D (double fx, double fy, double fz, double tz, int ix, int iy,
    int iz, int it, int seed = 0);
  ...
  int IntValueNoise4D (int x, int y, int z, int t, int seed = 0);
  ...
  double ValueCoherentNoise3D (double x, double y, double z, int seed = 0,
    NoiseQuality noiseQuality = QUALITY_STD);
  double ValueCoherentNoise4D (double x, double y, double z, double t, int seed = 0,
    NoiseQuality noiseQuality = QUALITY_STD);
  ...
  double ValueNoise4D (int x, int y, int z, int t, int seed = 0);
